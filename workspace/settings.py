...
SECRET_KEY = "django-insecure--8)v9ob^g#9sm*thrpzc&!1e8007qe_@c5+l#fyo2q4w0=yj+5"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            BASE_DIR / "static",
            BASE_DIR / "images",
            "/Workspace_console-main/workspace/static",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# provide these info based on your org ldap server
